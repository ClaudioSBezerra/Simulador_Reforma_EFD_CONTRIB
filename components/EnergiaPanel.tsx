...
const EnergiaPanel: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'0' | '1'>('0'); // 0: Créditos (C500), 1: Débitos (C600)
  ...
  // Mock de dados representativos para Água e Energia (C500 e C600)
  const rawRecords: SpedRecord[] = [
    { id: 'e1', ind_oper: '0', dt_doc: '2023-10-15', vl_doc: 125400, vl_bc_icms: 125400, vl_pis: 1200, vl_cofins: 5600, vl_icms: 22572, cnpj_c010: '12.345.678/0001-90', consumo: 12450 },
    { id: 'e2', ind_oper: '0', dt_doc: '2023-10-18', vl_doc: 15230.5, vl_bc_icms: 15230.5, vl_pis: 150, vl_cofins: 700, vl_icms: 0, cnpj_c010: '12.345.678/0001-90', consumo: 450 },
    { id: 'e3', ind_oper: '1', dt_doc: '2023-10-20', vl_doc: 89400, vl_bc_icms: 89400, vl_pis: 800, vl_cofins: 3800, vl_icms: 16092, cnpj_c010: '98.765.432/0001-01', consumo: 8900 },
    { id: 'e4', ind_oper: '0', dt_doc: '2023-11-10', vl_doc: 45000, vl_bc_icms: 45000, vl_pis: 430, vl_cofins: 1980, vl_icms: 8100, cnpj_c010: '12.345.678/0001-90', consumo: 4200 },
  ];
  ...
  // Extração de opções para os filtros baseado nos dados carregados
  ...
  const calculateProjections = (rec: any) => {
    ...
    // VL_ICMS_PROJETADO (REG_C500.VL_ICMS - ((REG_C500.VL_ICMS * tabela_aliquota.perc_reduc_icms)/100))
    const vlIcmsProj = rec.vl_icms - ((rec.vl_icms * currentAliquota.perc_reduc_icms) / 100);
    
    // VL_IBS_PROJETADO (REG_C500.VL_DOC * %TABELA_ALIQUOTA.PERC_IBS)
    const vlIbsProj = rec.vl_doc * (currentAliquota.perc_ibs / 100);
    
    // VL_CBS_PROJETADO (REG_C500.VL_DOC * %TABELA_ALIQUOTA.PERC_CBS)
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-white">Painel de Água e Energia</h2>
          <p className="text-[#92adc9] text-sm">Simulação de impacto em faturas de serviços básicos (C500/C600).</p>
        </div>
      ...
      <div className="bg-primary/5 border border-primary/20 p-4 rounded-lg">
        <p className="text-[11px] text-[#92adc9] leading-relaxed">
          <strong>Regras de Cálculo:</strong> O VL_ICMS_PROJETADO considera a redução escalonada do ICMS conforme o cronograma da Reforma. 
          As projeções de IBS e CBS incidem sobre o Valor Total do Documento (VL_DOC) nas alíquotas de {currentAliquota.perc_ibs}% e {currentAliquota.perc_cbs}% 
          respectivamente para o ano de {selectedYear}.
        </p>
      </div>
    </div>
  );
